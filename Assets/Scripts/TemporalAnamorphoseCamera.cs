...
class TemporalAnamorphoseCamera : MonoBehaviour {
    ...
    IEnumerator Start() {
        ...
        // _buffer = new Texture2DArray(512, 512, Resolution, TextureFormat.RGB565, false);
        _buffer = new Texture2DArray(1920, 1080, Resolution, TextureFormat.RGBA32, false);
